...
async function runMigration() {
  try {
    ...
    for (const [question, vata, pitta, kapha, order] of questions) {
      ...
      if (insertError) {
        console.error(`Error inserting question ${order}:`, insertError);
      } else {
        console.log(`Question ${order} inserted successfully`);
      }
    }
